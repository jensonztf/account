...
{
$sqlproc =  "D:\MyServer\MySQL\bin\mysql "
			 ."--host=localhost "
			 ."--user=root "
			 ."--password=jensonztf "
			 ."--database=jizhang "
			 ."--execute=\"source D:/MyServer/WWW/account/proc_asset_insert.sql\"";
}
...
$sqlproc =  "D:\MyServer\MySQL\bin\mysql "
			 ...
			 ."--password=jensonztf "
			 ."--database=jizhang "
			 ."--execute=\"source D:/MyServer/WWW/account/proc_asset_edit.sql\"";
}
echo shell_exec($sqlproc);
...
$sqlproc =  "D:\MyServer\MySQL\bin\mysql "
			 ...
			 ."--password=jensonztf "
			 ."--database=jizhang "
			 ."--execute=\"source D:/MyServer/WWW/account/proc_asset_install.sql\"";
}
echo shell_exec($sqlproc);
